...
Initial database created named : <b> dev-a-pr </b>; Owner of this database is <b> dev-a-pr-admin </b> ; look for secret named "edb-postgres-dev-a-pr-db-owner" for login details. 
...
Secrets [here](https://console-openshift-console.apps.devops.balancing.nationalgrideso.com/k8s/ns/edb-postgresql-dev-pr-1/secrets/azure-creds) are manually created from the azure storage account [stroage account](https://portal.azure.com/#@nationalgridplc.onmicrosoft.com/resource/subscriptions/7b4738c8-68b5-4c75-ac10-9682cbc4b398/resourceGroups/eso-dev-uks-edbbackup-rg/providers/Microsoft.Storage/storageAccounts/esodevuksedbbackup/overview)
